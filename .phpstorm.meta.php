...
namespace PHPSTORM_META {
    ...
    registerArgumentsSet('configs',
        ...
        'horizon.environments.staging.supervisor-1.balanceCooldown', 'horizon.environments.local.supervisor-1.maxProcesses', 'inertia.ssr.enabled', 'inertia.ssr.url', 'inertia.ensure_pages_exist',
    ...
    registerArgumentsSet('routes',
        ...
        'horizon.jobs.show', 'horizon.index', 'home', 'dashboard', 'profile.edit', 'profile.update', 'profile.destroy', 'password.edit',
        'password.update', 'appearance.edit', 'two-factor.show', 'register', 'register.store',
